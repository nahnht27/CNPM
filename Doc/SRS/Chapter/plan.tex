...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|c|Y|Y|L{1.8cm}|Y|}
		\hline
		\textbf{\#} &
		\textbf{Risk Description} &
		\textbf{Impact} &
		\textbf{Possibility} &
		\textbf{Response Plans} \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|Y|Y|L{2cm}|L{2cm}|Y|}
		\hline
		\textbf{Training Area} &
		\textbf{Participants} &
		\textbf{When} &
		\textbf{Duration} &
		\textbf{Waiver Criteria} \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|L{1.2cm}|L{2.5cm}|Y|}
		\hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|Y|Y|L{2.5cm}|Y|}
		\hline
		\textbf{Communication} &
		\textbf{Participants} &
		\textbf{Frequency} &
